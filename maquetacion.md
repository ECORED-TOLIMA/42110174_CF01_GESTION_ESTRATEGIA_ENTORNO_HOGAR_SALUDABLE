...
Estado: en progreso
Observaciones: se creó la primera maquetación funcional con seis temas, 21 anclajes, introducción, síntesis, glosario, referencias y 20 preguntas. El proyecto dispone de imagen1.png a imagen4.png para la actividad y la secuencia se reutilizó de forma cíclica. Falta exportar y clasificar por tema los recursos visuales internos del archivo .xd y reemplazar los recursos gráficos genéricos de la plantilla.
```
